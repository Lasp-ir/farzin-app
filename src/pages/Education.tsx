...
export default function Education() {
  ...
  // 🔥 خواندن سهمیه روزانه از حافظه (برای دموی فعلی سهمیه را ۱ در نظر می‌گیریم)
  ...
  // 🔥 استفاده از سهمیه روزانه و ورود به دوره پولی
  const handleUseQuota = () => {
    setDailyQuota(0);
    localStorage.setItem('farzin_daily_quota', '0');
    setSelectedPreviewCourse(null);
    console.log('User used their daily quota for:', selectedPreviewCourse.id);
    // navigate(`/course/${selectedPreviewCourse.id}`);
  };
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-2xl px-5 py-6 flex items-center justify-between z-20 sticky top-0 bg-[#161512]/90 backdrop-blur-xl border-b border-white/5">
          ...
          <div className="w-10 flex justify-end">
            {/* نمایشگر سهمیه روزانه بالا سمت چپ */}
            {!isUserPremium && (
      ...
      {/* 🔥 پاپ‌آپ استراتژیک برای دوره‌های پولی (Paywall / Quota) */}
      <AnimatePresence>
          ...
          >
            ...
            >
                ...
                <div className="p-6 pt-2 flex flex-col items-center text-center gap-4">
                    ...
                    {/* پیام متغیر بر اساس داشتن سهمیه */}
