...
import { 
  ...
  Search, PlayCircle, X, CheckCircle2, Loader2
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  // 🌟 استیت‌های مربوط به دیتا
  const [courses, setCourses] = useState<any[]>([]);
  const [isLoading, setIsLoading] = useState(true);
  
  // 🌟 استیت‌های مربوط به مودال ساخت دوره
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center gap-4 text-xs font-bold text-zinc-500">
                                        ...
                                        <span className="flex items-center gap-1.5"><Video size={14}/> {course._count?.lessons || 0} جلسه</span>
                                        <span className="flex items-center gap-1.5 text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">{course._count?.enrollments || 0} دانشجو</span>
                                    </div>
                                </div>
                            </div>
